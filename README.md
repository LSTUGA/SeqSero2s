...
3. Add a fliC 1,5,7 allele and a fliC 1,2,7 allele into the SeqSero2 database.
-fliC_1,5,7_Salmonella.enterica_from-cdc-Stk1778_1,5,7_1521
-fliC_1,2,7_Salmonella.enterica_from-cdc-Stk2293_1,2,7_1521
4. delete the O54 allele
-O-54_wbbF__1380
5. Fixed the bug that caused the misidentification of O9 and O2 by the micro-assembly workflow
6. Update serotype names based on the simplified KWS scheme
7. Remove the 9,46,27 allele
-O-9,46,27_partial_wzy__1019
8. Remove two fljB_1,2 allels
